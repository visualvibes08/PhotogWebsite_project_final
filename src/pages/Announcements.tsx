...
const Announcements = () => {
  ...
  const announcements = [
    {
      id: 1,
      title: "Welcome to PHOTOG WEBSITE",
      date: "JUNE 19 2025",
      image: "https://wallpaperaccess.com/full/3214373.jpg",
      content: "We, the member of Photography Section IIT Roorkee always try to showcase the beauty of campus as well as the talent who captures the beauty the best possible way and this website has been developed in the view of that."
    },
    // {
    //   id: 2,
